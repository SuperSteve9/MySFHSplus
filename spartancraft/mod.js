...
fn vsMain(
    ...
    out.triID = f32(vID / 3u);
    return out;
}

@fragment
fn fsMain(@location(0) triID: f32) -> @location(0) vec4f {
    let r = fract(triID * 0.37);
    let g = fract(triID * 0.61);
    let b = fract(triID * 0.83);
